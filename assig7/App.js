...
const App = () => {
    ...
    return (
      <View style={styles.productCard}>
        ...
        <View style={styles.productButtons}>
          <TouchableOpacity style={styles.button} onPress={() => alert('Add to Cart clicked')}>
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      {page === 'Products' && productsPageVisible && renderProductsPage()}
      {page === 'MyFavorites' && renderMyFavoritesPage()}
    </SafeAreaView>
  );
};
